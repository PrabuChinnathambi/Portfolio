                ...
                <Fade bottom>
                    <div className="greeting_education">
                        ...
                        <div className="edu_quotes">
                            <h1>Education</h1>
                            <h4> “Live as if you were to die tomorrow. Learn as if you were to live forever” – Mahatma Gandhi</h4>
                        </div>
                    </div>
                </Fade>
                            ...
                            <Fade right>
                                <div className="degree_details">
                                    <div className="degree_head">
                                        ...
                                        <h4>BSc Information Technology ( Bharathiyar University )</h4>
                                        <p className="year">2016 - 2019</p>
                                    </div>
                                    <div className="degree_points">
                                        <p>⚡ I have studied basic software subjects like Java, C++, Html, Css, DS, DBMS, OS etc.</p>
                                        <p>⚡ Apart from this, I have done courses Pyhton, ASP.Net, React and Full Stack Development.</p>
                            ...
                            <Fade right>
                                <div className="degree_details">
                                    ...
                                    <div className="degree_points">
                                        ...
                                        <p>⚡ Also studied mager subjects of Pyshics, Chemistery and Maths</p>
                                        <p>⚡ Apart from this, I have played division level hockey</p>
                                    </div>
                                    <div className="gpa">
                                        <p>GPA - 84.66%</p>
                                    </div>
                        ...
                        <div className="college">
                            ...
                            <Fade right>
                                <div className="degree_details">
                                    ...
                                    <div className="degree_points">
                                        <p>⚡ I have studied basics of computer and core subjects</p>
                                        <p>⚡ Apart from this, I got a district level hockey winner certificate</p>
                                    </div>
                                    <div className="gpa">
                                        <p>GPA - 87.40%</p>
                                    </div>
