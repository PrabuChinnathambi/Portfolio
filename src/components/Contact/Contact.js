            ...
            <div className="contact_container">
                <Fade bottom>
                    <div className="contact_greeting">
                        ...
                        <Fade right>
                            <span className="quote">Nothing is Impossible But Everything is Possible...</span>
                        </Fade>
                    </div>
                </Fade>
                <div className="contact_content">
                    <Fade bottom>
                        <div className="contact_me">
                            <div>
                                <h2>Contact Me</h2>
                                <p>I am available on almost every social media. You can message me, I will reply within 24 hours. I can help you with React, Asp.Net, Pyhton, Cloud and Opensource Development.</p>
                    ...
                    <Fade bottom>
                        <div className="address">
                            ...
                            <div>
                                <h2>Address</h2>
                                <p>7/277 Sellampalayam, P.Puliampatti, Sathy, Dist.- Erode, TamilNadu - 638459 </p>
                                <h2>Phone Number</h2>
                                <p>+91 9080853926</p>
                                <h2>Email</h2>
