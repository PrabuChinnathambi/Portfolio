        ...
        <Fade bottom>
          <div className="exp_greeting">
            ...
            <div className="exp_greeting_quotes">
              <h1>Experience</h1>
              <h4>
                “Learn from every mistake, because every experience particularly
                your mistakes, are there to teach you and force you into being
                more of who you are.” - Oprah Winfrey
              </h4>
            </div>
          </div>
        </Fade>
              ...
              <div className="exp_card">
                ...
                <div className="exp_details">
                  ...
                  <div className="detail_body">
                    ...
                    <span>
                      <img
                        src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/320/apple/285/backhand-index-pointing-right_1f449.png"
                        alt="emoji"
                      />
                      <Fade right>
                        <p>
                          I'm currently working in Unilever project in Infosys.
                          The roll should I have to manage 10 more applications
                          already in live. Maintaining and supporting the ticket
                          issues. Resolve the issue within a time and deliver to
                          the client.
                        </p>
                      </Fade>
                    </span>
                    ...
                    <span>
                      ...
                      <Fade right>
                        <p>
                          I have worked in front-end development team. It's kind
                          of Migration process. Previously all the applications
                          are deployed in a walmart server. Our roll to moving
                          all those apps to cloud platform of Azure. Technology
                          which i have used Asp.Net,Azure,C#...etc
                        </p>
                      </Fade>
                    </span>
                    ...
                    <span>
                      ...
                      <Fade right>
                        <p>
                          I got more skills in my training. Especially, I have
                          trained one month for Python basics and RDBMS. Later I
                          got full knowledge about web development through C#,
                          Asp.Net, DBMS
                        </p>
                      </Fade>
                    </span>
                ...
                <div className="exp_details">
                  ...
                  <div className="detail_body">
                    <span>
                      ...
                      <Fade right>
                        <p>
                          Primary responsible for gathering and analyzing data,
                          maintaining and constantly improving the quality of an
                          organization's data, and collaborating with the
                          research team to present data in a convincing way
                        </p>
                      </Fade>
                    </span>
                  </div>
