              ...
              <Fade right>
                <div className="content_right">
                  ...
                  <div className="skill_logos">
                    ...
                    />
                    <img
                      src="https://img.icons8.com/color/2x/c-sharp-logo-2.png"
                      alt="img"
                    />
                  </div>
                  <div className="skill_points">
                    <p>
                      ⚡ Building resposive website front end using React app
                    </p>
                    <p>
                      ⚡ Creating application backend in Node, Express & MongoDB
                    </p>
                    <p>
                      ⚡ Building Full stack web app using MERN stack technology
                    </p>
                  </div>
                </div>
              </Fade>
              ...
              <Fade right>
                <div className="content_right">
                  ...
                  <div className="skill_logos">
                    ...
                    />
                    <img
                      src="https://img.icons8.com/color/2x/google-firebase-console.png"
                      alt="img"
                    />
                    <img
                      src="https://img.icons8.com/color/2x/azure-1.png"
                      alt="img"
                    />
                    <img
